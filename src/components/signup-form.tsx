...
const SignupForm: React.FC<SignupFormProps> = ({
  ...
  const submitForm: SubmitHandler<UserSignUpSchemaType> = (
    form: UserSignUpSchemaType
  ) => {
  ...
  return (
    <div className='container mx-auto md:w-9/12'>
      <div className='text-center md:mb-6'>
        <h1 className='mb-2 mt-6 text-xl font-bold'>Welcome to Intracom</h1>
        <p>
          We&apos;re excited to have you join us. Let&apos;s get to know each
          other a little better.
        </p>
      </div>
      <div className='my-3 md:mx-auto md:max-w-lg'>
