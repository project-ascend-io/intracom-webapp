    ...
    <>
      ...
      >
        ...
        >
          ...
          <p>
            Welcome to Intracom, an internal communication tool designed for
            startups, nonprofits, and small companies. This Privacy Policy
            explains how we collect, use, and protect your personal information
            when you use our chat application. By using Intracom, you agree to
          ...
          <p>
            ...
            your name, email address, and organization details. This information
            is used to create and manage your account.
          </p>

          <h3 style={{ color: '#4CAF50' }}>b. Communication Data:</h3>
          <p>
            We collect the content of messages, files, and other communications
            that you send or receive through Intracom. This data is stored
            securely to enable communication within your organization.
          </p>

          <h3 style={{ color: '#4CAF50' }}>c. Usage Data:</h3>
          <p>
            We collect information about how you use Intracom, including log
            data, IP addresses, device information, and browsing history. This
            data helps us improve our services and ensure the security of our
            application.
          </p>
          ...
          <p>
            We use your information to provide you with access to Intracom and
            to improve the functionality and performance of our application.
          </p>

          <h3 style={{ color: '#4CAF50' }}>b. To Communicate with You:</h3>
          <p>
            We may use your email address to send you important updates,
            notifications, or support-related communications.
          </p>

          <h3 style={{ color: '#4CAF50' }}>c. To Ensure Security:</h3>
          <p>
            We use your information to detect and prevent fraudulent activities,
          ...
          <p>
            Your communications and data within Intracom are shared with other
            members of your organization. It is your responsibility to ensure
            that you do not share sensitive information unless you trust the
            recipients.
          </p>
          ...
          <p>
            ...
            providers who assist us in operating and improving Intracom. These
            providers are bound by confidentiality agreements and are only
            allowed to use your information as necessary to provide their
            services.
          </p>
          ...
          <p>
            ...
            Communication data is stored for the duration of your account&apos;s
            existence unless you or your organization request deletion.
          </p>
          ...
          <p>
            ...
            hold about you. You can update your account information through the
          ...
          <p>
            ...
            information at any time. Please note that some information may be
          ...
          <p>
            ...
            application. Your continued use of Intracom after any changes to
          ...
          <p>
            ...
            please contact us at oscar@projectascend.io
          </p>
        </div>
      </div>
    </>
