  ...
  return (
    <footer className="footer bg-base-200 text-base-content p-10">
      <aside>
        ...
        <p>
          &copy; Project Ascend. {new Date().getFullYear()}.
        </p>
      </aside>
      <nav>
...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      < div className='text-center' >
        <div className=''>
          <h1 className='bg-gradient-to-r from-green-400 via-purple-500 to-pink-500 bg-clip-text py-2 text-6xl font-bold text-transparent'>
            Coming Soon
          </h1>
