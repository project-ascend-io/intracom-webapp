...
const ViewUserInvitePage = () => {
  ...
  const { invite, isLoading, error, setInvite, setIsLoading } =
    useInvite(params);
  ...
  if (invite?.state == InviteState.Denied) {
    const handleFeedbackSubmit = async (
      ...
      const updateInvite = await fetch(
        API_URL + '/user-invites/' + invite.hash,
        {
      ...
      <>
        <div className="container mx-auto md:w-9/12">
          <div className="text-center mb-12 md:mb-6">
            ...
            <p>
              Before completing your request, can you provide feedback on why
