...
export async function fetchElectronJsContributors(): Promise<
  GithubContributor[]
> {
  const owner = 'project-ascend-io';
...
export async function fetchExpressJsContributors(): Promise<
  GithubContributor[]
> {
  const owner = 'project-ascend-io';
...
export async function fetchDesignerContributors(): Promise<
  GithubContributor[]
> {
    ...
    resolve([
      {
        ...
        node_id: '',
        avatar_url:
          'https://media.licdn.com/dms/image/v2/C5603AQHsH-B4K4gJ0w/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1602702782705?e=1742428800&v=beta&t=vbxQ_cWVFh1GMqZM_nHEw2RAyGxBlaSwVpA68a_zEhE',
        gravatar_id: '',
        url: '',
