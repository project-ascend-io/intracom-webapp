                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 py-6">
                    <div className="lg:col-span-4">
                        ...
                        <div className="flex justify-between rounded-xl border-2 border-solid py-5 px-5 my-3">
                            ...
                            <div>
                                <button className="btn btn-primary rounded-xl text-white p-3">Download</button>
                            </div>
                        </div>
                        <div className="flex justify-between rounded-xl border-2 border-solid py-5 px-5 my-3">
                            <div>
                        ...
                        <p className="textarea-secondary mt-6 mb-3">Already have the app?</p>
                        <button className="btn btn-neutral rounded-xl text-white p-3 w-72">Open Intracom</button>
                    </div>
                    <div className="hidden lg:block">
                        <img className="rounded-xl" src="https://picsum.photos/200/600"  alt="intracom-banner"/>
                    </div>
                </div>
            </div>
        </>
